...
given, and consists of a number of steps. At each step, pull() is called to get
an entity from the queue so that it can act.  When the knock-on effects from one
user command have finished, pull() returns null and the round ends.
...
class Queue<E> {
    ...
    // Pull an entity from the front of the queue, or return null.
    E pull() { return actors.pollFirst(); }
